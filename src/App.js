...
export function Model(props) {
  ...
  return (
    ...
    <IconLink url="https://www.instagram.com/tahasafs">
      ...
      {/* loinkedon */}
    <IconLink url="https://www.linkedin.com/in/taha-sarfraz-54b429274/">
...
const DisplayHoverableCube = forwardRef(function HoverableCube(
  ...
  const handleClick = () => {
    ...
    gsap.to(camera.position, {
      ...
      ease: 'power2.out',
      onComplete: () => {
        setShowHtml(true) // Show the provided content
    ...
    // controls.target = controls.target || new THREE.Vector3();
    // controls.target.set(position[0], position[1], position[2])
  ...
  return (
    <group>
      <mesh
        ...
        <boxGeometry args={[1, 1, 1]} />
        <meshStandardMaterial color="black" transparent={false} opacity={0.01} />

        {showHtml && ContentComponent && (
          <Html
            className="content"
            transform
            position={[-0.025, -0.7, 0]}
            rotation={[1, 0, 3.13]}
            distanceFactor={3}
            occlude
            ...
            <div
              ...
              <ContentComponent /> {/* Dynamically render the passed component */}
            </div>
          </Html>
        )}
      </mesh>
...
export default function App() {
  ...
  const hoverableCubeRef = useRef() // We'll hold the ref to call .reset()
  const heroPageCubeRef = useRef() // add ref of other page here
...
{/* 
        ...
        <ResetCameraButton
          ...
          // if you have multiple displays, add the ref here
          // e.g
          // cubeRefs={[ heroPageCubeRef, anotherCubeRef ]}
